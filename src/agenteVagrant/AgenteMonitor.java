	...
	public class AgenteMonitor extends Agent {
		...
		protected void setup() {
	        ...
	        try {
	        	...
	        	String[] command4 = {vagrant3, vagrant2,"cd " + "C:\\HashiCorp\\Vagrant\\"+usuario+ " && vagrant ssh -c 'sudo apt-get install dstat'"};
	            ...
	            String[] command = {vagrant3, vagrant2,"cd " + "C:\\HashiCorp\\Vagrant\\"+usuario+ " && vagrant ssh -c 'dstat -cmdn '"};
	          ...
	          // String media;
	            ...
	            while (  (line = reader.readLine()) != null) {
	            	//System.out.println("entrou 3");
						...
						//System.out.println("Digite 's' para destruir a maquina, enquanto ela está executando");
						...
						/*if(r0.equals("S") || r0.equals("s")) {
							...
							// System.out.println("Media de CPU usada ="+mediaCpu);
								//System.out.println("Media de Memoria usada em MegaBits ="+mediaMem);
								    ...
								    FileWriter arq = new FileWriter("C:\\HashiCorp\\Vagrant\\"+usuario+"\\MediaCpuMem"+usuario+".txt");
								   ...
								   // System.out.println("Salvo em C:\\\\Users\\\\vinic\\\\Documents\\\\MediaCpuMem.txt");
	            ...
	            String[] commandd = {vagrant3, vagrant2,"cd " + "C:\\HashiCorp\\Vagrant"+ " && vagrant destroy -f"};
