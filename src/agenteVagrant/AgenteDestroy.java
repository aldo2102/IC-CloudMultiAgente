...
public class AgenteDestroy extends Agent {
	...
	protected void setup() {
        ...
        //System.out.print("Escreva o nome da maquina que será destruída");
        usuario=JOptionPane.showInputDialog(null,"Escreva o nome da maquina que será destruída","ALERTA",JOptionPane.WARNING_MESSAGE);
        String a;
      ...
      //   usuario=ler.next();
        ...
        try {
        String[] commandd = {vagrant3, vagrant2,"cd " + "C:\\HashiCorp\\Vagrant\\"+usuario+ " && vagrant destroy -f"};
